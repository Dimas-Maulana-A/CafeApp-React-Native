...
const EditMenuKasir = ({route}) => {
  ...
  const handleSubmit = e => {
    ...
    images
      ...
      : '';
    auth
      .put(baseMenu+idCategoryMenu, formData, {
        headers: {
