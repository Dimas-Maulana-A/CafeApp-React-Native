...
import {Templates, Column, Space, PrimaryButtons} from '../../../../components';

const ReportDetailsDeveloper = ({route}) => {
    ...
    <View style={styles.Container}>
      <Templates m_Horizontal={'5%'} m_Vertical={'5%'}>
        ...
        <Column>
          ...
          <Space Height={8} />
          <Text style={styles.boxDetails}>{reportDate}</Text>
        </Column>
        <Space Height={20} />
        {data.status ? (
          ''
...
export default ReportDetailsDeveloper;
